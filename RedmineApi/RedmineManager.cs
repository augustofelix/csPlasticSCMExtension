...
namespace Redmine.Net.Api
{
    ...
    public class RedmineManager
    {
        ...
        public RedmineManager(string host) : this(host, true)
        {
        }
        ...
        /// <param name="host">The host.</param>
        /// <param name="verifyServerCert">if set to <c>true</c> [verify server cert].</param>
        public RedmineManager(string host, bool verifyServerCert)
        {
            this.host = host;
        ...
        public RedmineManager(string host, string apiKey) : this(host, apiKey, true)
        {
        }
        ...
        /// <param name="apiKey">The API key.</param>
        /// <param name="verifyServerCert">if set to <c>true</c> [verify server cert].</param>
        public RedmineManager(string host, string apiKey, bool verifyServerCert)
        ...
        /// <param name="password">The password.</param>
        /// <param name="verifyServerCert">if set to <c>true</c> [verify server cert].</param>
        public RedmineManager(string host, string login, string password, bool verifyServerCert)
            : this(host, verifyServerCert)
        {
        ...
        /// <param name="parameters">The parameters.</param>
        /// <returns></returns>
        public User GetCurrentUser(NameValueCollection parameters)
        {
        ...
        public IList<T> GetObjectList<T>(NameValueCollection parameters) where T : class
        {
            ...
            using (var wc = CreateWebClient(parameters))
            {
                ...
                using (var text = new StringReader(result))
                {
                    ...
                    //{
                    var xmlReader = new XmlTextReader(text)
                    {
        ...
        protected static string Serialize<T>(T obj) where T : class
        {
            ...
            using (var stringWriter = new StringWriter())
            {
                ...
                //{
                    var xmlWriter = XmlWriter.Create(stringWriter, xws);
